...
class ScoreboardPageState extends State<ScoreboardPage> {
  ...
  void initState() {
    ...
    timer = Timer.periodic(const Duration(minutes: 30), (Timer t) => checkNewStories());
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Column(children: [
          ...
          const Text("News", style: TextStyle(fontSize: 14, color: Colors.white)),
          const SizedBox(height: 5),
          Row(mainAxisAlignment: MainAxisAlignment.start, children: [Text("Scoreboard", style: settingsTextStyle)]),
